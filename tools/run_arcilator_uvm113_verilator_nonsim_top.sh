...
# Run arcilator in top-executed mode (`RUNNERS=arcilator_top`) on the subset of
# "UVM113" tests whose sv-tests metadata does NOT include `:type: simulation`
# (i.e. elaboration/parsing-only in the upstream scoring).
...
OUT_DIR="${OUT_DIR:-"${SVTESTS_DIR}/out_arcilator_top_uvm113_verilator_nonsim"}"
