...
TEST_LIST_FILE="${TEST_LIST_FILE:-"${WS_ROOT}/tempnotes/NOTES/m2_runtime_acceptance_tests.txt"}"

OUT_ARC="${OUT_ARC:-out_arcilator_m2_runtime_accept}"
OUT_VER="${OUT_VER:-out_Verilator_m2_runtime_accept}"
...
out_arc = os.environ.get("OUT_ARC", "out_arcilator_m2_runtime_accept")
out_ver = os.environ.get("OUT_VER", "out_Verilator_m2_runtime_accept")
