...
# Run arcilator in DUT mode on all UVM-tagged tests that are NOT part of the
# `tools/data/uvm113_tests.txt` list.
#
...
OUT_DIR="${OUT_DIR:-"${SVTESTS_DIR}/out_arcilator_dut_uvm_not_in_uvm113"}"
